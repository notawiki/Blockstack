...
export default function () {
  ...
  // Reset replace keys automatically
  let settings = Storage.load('settings')
  settings.replaceList = Storage.getStructur().settings.replaceList
  Storage.save('settings', settings)

  console.timeEnd('Startup handler')
}
